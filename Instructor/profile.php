...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email)) {
        ...
        try {
            ...
            $emailCheck = $db->prepare("SELECT instructor_id FROM instructor WHERE email = ? AND instructor_id != ?");
            $emailCheck->bind_param("si", $email, $instructor_id);
            $emailCheck->execute();
            if ($emailCheck->get_result()->num_rows > 0) {
                ...
                $updateStmt->bind_param("ssssi", $name, $email, $phone, $bio, $instructor_id);
                ...
                if ($updateStmt->execute()) {
                    ...
                    if (!empty($current_password) && !empty($new_password)) {
                        if ($new_password !== $confirm_password) {
                            ...
                            $passwordStmt = $db->prepare("UPDATE instructor SET password = ? WHERE instructor_id = ?");
                            $passwordStmt->bind_param("si", $hashed_password, $instructor_id);
            ...
            <div class="col-lg-8">
                <div class="profile-card">
                    ...
                    <div class="profile-header text-center">
                        ...
                        <h2 class="mb-1"><?php echo htmlspecialchars($instructor['name']); ?></h2>
                        <p class="mb-0 opacity-75">Instructor Profile</p>
                    </div>
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="bio" name="bio" rows="4" 
                                          placeholder="Tell students about yourself..."><?php echo htmlspecialchars($instructor['bio'] ?? ''); ?></textarea>
                            </div>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="instructor_dashboard.php" class="btn btn-outline-secondary me-md-2">Cancel</a>
